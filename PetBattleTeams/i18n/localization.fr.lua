...
local baseLocale = {
    ...
    ["Display team description in tooltip"] = "Afficher la description de l'\195\169quipe dans l'infobulle",
    ["Show team description during pet battles"] = "Afficher la description de l'\195\169quipe pendant les combats de mascottes",
    ["Team Description"] = "Description de l'\195\169quipe",
    ["Press Ctrl+Enter to save the description"] = "Appuyez sur Ctrl+Entrée pour sauvegarder la description",
    ["OK"] = "OK",
    ["Cancel"] = "Annuler",
