...
local baseLocale = {
    ...
    ["Display team description in tooltip"] = "Display team description in tooltip",
    ["Show team description during pet battles"] = "Show team description during pet battles",
    ["Team Description"] = "Team Description",
    ["Press Ctrl+Enter to save the description"] = "Press Ctrl+Enter to save the description",
    ["OK"] = "OK",
    ["Cancel"] = "Cancel",
